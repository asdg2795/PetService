...
//	하나의 단위로 묶어서 가져온다
	...
	private int applytotalRecord;	//총레코드 수
	...
	public int getTotalRecord() {
		return applytotalRecord;
	}

	public void setTotalRecord(int applytotalRecord) {
		this.applytotalRecord = applytotalRecord;
		// 총페이지수
		totalPage = (int) Math.ceil( applytotalRecord / (double)onePageRecord);
		/*
