...
//	하나의 단위로 묶어서 가져온다
	...
	private int grouptotalRecord;	//총레코드 수
	...
	public int getTotalRecord() {
		return grouptotalRecord;
	}

	public void setTotalRecord(int grouptotalRecord) {
		this.grouptotalRecord = grouptotalRecord;
		// 총페이지수
		totalPage = (int) Math.ceil( grouptotalRecord / (double)onePageRecord);
		/*
