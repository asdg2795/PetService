...
//	하나의 단위로 묶어서 가져온다
	...
	private int bookmarktotalRecord;	//총레코드 수
	...
	public int getTotalRecord() {
		return bookmarktotalRecord;
	}

	public void setTotalRecord(int bookmarktotalRecord) {
		this.bookmarktotalRecord = bookmarktotalRecord;
		// 총페이지수
		totalPage = (int) Math.ceil( bookmarktotalRecord / (double)onePageRecord);
		/*
